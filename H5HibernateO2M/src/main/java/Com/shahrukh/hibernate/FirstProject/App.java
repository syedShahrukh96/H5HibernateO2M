...
public class App {
    public static void main(String[] args) {
    	...
    	Employee emp = new Employee("raja","Executive","Marketing");
    	List<Address> addressList = new ArrayList<>();
    	
    	addressList.add(new Address("Bangaloriiii","Karnataka",60640, emp));
    	addressList.add(new Address("Fangaloriii","Tarnataka",60641, emp));
    	addressList.add(new Address("Kangalorii","Parnataka",60642, emp));
